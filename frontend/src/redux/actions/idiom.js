...
* Updated by Romy, 2019-11-13, for integrating redux-saga.
*/

import { ADD_IDIOM, UPDATE_IDIOM, DELETE_IDIOM, CHANGE_CATEGORY, LOAD_IDIOMS, LOAD_CLASSIFYLIST, ADD_CLASSIFY, DELETE_CLASSIFY} from '../../constants';
...
export function deleteClassify(id) {
    return { type: DELETE_CLASSIFY, id }
};
