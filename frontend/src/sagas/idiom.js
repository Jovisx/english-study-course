...
import { SERVER_ADDRESS,
    ...
    UPDATE_IDIOM, UPDATED_IDIOM, DELETE_IDIOM, DELETED_IDIOM, ADD_CLASSIFY, DELETE_CLASSIFY, DELETED_CLASSIFY} from '../constants';
...
//Delete Classify
export function* postClassifyDelete(action) {
    const url = SERVER_ADDRESS + 'classify/delete';
    ...
    yield put( { type: DELETED_CLASSIFY, id: action.id});
}

export function* deleteClassify() {
    yield takeLatest(DELETE_CLASSIFY, postClassifyDelete);
}
...
export default function* rootSaga() {
    ...
    yield fork(deleteClassify)
    yield fork(addIdiom)
    yield fork(updateIdiom)
    yield fork(deleteIdiom)
